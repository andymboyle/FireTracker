...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fires_title', (
            ...
            ('employer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.Department'], null=True, blank=True)),
        ))
        ...
        db.create_table('fires_station', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('name_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
            ('department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.Department'])),
        ...
        # Adding model 'Source'
        db.create_table('fires_source', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.Person'])),
        ))
        db.send_create_signal('fires', ['Source'])
